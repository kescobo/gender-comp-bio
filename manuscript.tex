...
\item Mean probability of authors being female in arXiv preprints in a given year. Error bars represent 95\% confidence intervals. Slopes were determined using linear regression. The slope for q-bio is slightly positive (p < 0.5), but the slope for cs is not.
\end{enumerate}

\subsection*{S1 Figure: Gender Inference Validation}
\begin{enumerate}[label=\Alph*]
